        ...
        <div className="sidebar w-full xl:w-1/3 2xl:w-1/2 flex flex-col xl:gap-10 p-4">
          ...
          <Accordion>
            <div className="flex flex-col xl:max-w-2xl lg:text-lg">
              <p>
                Oh man, it&apos;s easier to program this whole website than writing down some thoughts about the music.
                How do they say? Writing about music is like dancing about architecture.
              </p>
              <p>
                Ok, I&apos;m not a musician, I just wanted to write down some thoughts, feelings, colours, glimpses.
                Moments that deserved to be captured.
              </p>
              <p>

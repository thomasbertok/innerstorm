...
export const sortPlaylist = (playlist, sortBy, order = "asc") => {
  return [...playlist].sort((a, b) => {
    ...
    if (sortBy === "title") {
      ...
      const parsedYearA = parseInt(a.year, 10);
      const parsedYearB = parseInt(b.year, 10);
      const yearA = a.year === "Unknown" || isNaN(parsedYearA) ? null : parsedYearA;
      const yearB = b.year === "Unknown" || isNaN(parsedYearB) ? null : parsedYearB;
